...
import com.cii3m.cm.handler.converter.VerticesDetector;
import com.cii3m.cm.handler.converter.VerticesMerger;
import org.springframework.stereotype.Component;

import java.awt.image.BufferedImage;

@Component
public class PointHandler implements HandlerConverter {
  ...
  public PointHandler(
      ...
      VerticesDetector verticesDetector,
      VerticesMerger verticesMerger
  ) {
    denoiser.setNextImageProcessing(grayscaleConverter)
        ...
        .setNextImageProcessing(verticesDetector)
        .setNextImageProcessing(verticesMerger);
